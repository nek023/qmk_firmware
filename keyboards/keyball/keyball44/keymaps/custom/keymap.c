...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LALT  , KC_LGUI  ,       KC_LGUI , LT(1, KC_LNG2) , KC_ENT   ,                                        KC_SPC   , LT(2, KC_LNG1) , _______ ,       _______  , KC_MCTL
  ),

  [1] = LAYOUT_universal(
    KC_ESC   , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     ,                                        KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  ,                                        _______  , KC_MINS  , KC_EQL   , KC_BSLS  , KC_LBRC  , KC_RBRC  ,
